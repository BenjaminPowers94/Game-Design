...
namespace BensFinalGameAssignment
{
    class Enemy : DrawableGameComponent
    {
        ...
        const int STANDFRAMEWIDTH = 67;     //all values from spritesheet.txt
        ...
        bool isShooting = false; //is the blue shooting?
        ...
        public Enemy(Game game, SpriteBatch spriteBatch, Texture2D playerTexture, Background background) : base(game)
        {
            ...
            //add the stand frame
            playerFrames.Add(new Rectangle(67, 190, STANDFRAMEWIDTH, STANDFRAMEHEIGHT));

            //adding the gunshot sound
            ...
            playerFrames.Add(new Rectangle(71, 0, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(142, 0, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(0, 95, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(71, 95, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(142, 95, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(213, 0, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(284, 0, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(213, 98, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(355, 0, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));
            playerFrames.Add(new Rectangle(284, 95, WALKFRAMEWIDTH, WALKFRAMEHEIGHT));

            //the jump frame
            playerFrames.Add(new Rectangle(423, 95, JUMPFRAMEWIDTH, JUMPFRAMEHEIGHT));
        ...
        public void Start()
        {
            _rectangle = new Rectangle(1150, 0, (int)(SCALE * STANDFRAMEWIDTH), (int)(SCALE * STANDFRAMEHEIGHT));
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (keyState.IsKeyDown(Keys.NumPad0) || keyState.IsKeyDown(Keys.Down)) //for shooting for blue player
            {
                if (bulletDelay >= bulletDelayTime)
                {
                    gunSound.Play();
            ...
            foreach (Bullet bullet in bulletList)
            {
                Player player = Game.Components.OfType<Player>().First();

                if (player != null && bullet.Bounds.Intersects(player.Rectangle))
                {
                    health--;
